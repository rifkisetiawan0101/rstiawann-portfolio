...
const ProjectCard = ({ project, onOpenModal }: { project: Project; onOpenModal: (project: Project) => void; }) => {
    ...
    const links = project.links as { trailer?: string; itch?: string; live?: string; github?: string;  };
                ...
                <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-700/50 flex flex-col gap-3">
                        ...
                        <div className="grid grid-cols-3 gap-2 text-sm">
                            ...
                            {links?.itch && <a href={links.itch} target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-indigo-400 bg-slate-700/50 hover:bg-slate-700 p-2 rounded-md flex items-center justify-center gap-1.5 transition-colors"><ExternalLink size={16}/> Itch.io</a>}
