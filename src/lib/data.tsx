export const personalInfo = {
    name: "Rifki Setiawan",
    roles: ["Game", 2000, "Fullstack", 1500],
    ...
    cvLink: "https://xlpxspzgpauaedlqbxoz.supabase.co/storage/v1/object/public/rstiawann-assets/CV/CV_Rifki%20Setiawan_Game-Programmer_English.pdf",
    socials: {
